...
Model family substitution from the original proposal draft (Qwen2.5-Instruct) to Qwen3.5, matching the companion registered report [@chen2026error] under the same size-class-preserving, non-thinking-mode contingency, changed no hypothesis or grid — only the checkpoint family [@qwen2026qwen35; @yang2025qwen3].
