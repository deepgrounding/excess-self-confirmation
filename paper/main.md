...
- Freeze order, with dates from the development repository's commit history: design, prompts/rubrics, and analysis plan, tag `prereg-opt2-v2` (2026-07-12) $\to$ item screen and bins (2026-07-13 and 2026-07-15) $\to$ noise calibration $(\tau,\lambda)$, tag `prereg-opt2-v2-noise` (2026-07-25) $\to$ main arms (from 2026-07-30) $\to$ analysis unblinding.
